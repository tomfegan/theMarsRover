...
public class UserInputValidation {
    ...
    public int getRoverStartingCoordinateFromUser(String xOrY, PlateauSize grid, String plane) {
        System.out.print("Where would you like to place the Rover on the " + grid.getColumns() + "x" + grid.getRows() + " plateau: please provide the " + xOrY +"-coordinate: ");
    ...
    public int getRoverStartingXCoordinateWithinPlateau(PlateauSize grid, int coordinate, String plane, String xOrY) {
        while (coordinate > grid.getColumns()) {
    ...
    public int getRoverStartingYCoordinateWithinPlateau(PlateauSize grid, int coordinate, String plane, String xOrY) {
        while (coordinate > grid.getRows()) {
            System.out.println("Out of bounds - please try again");
            coordinate = getRoverStartingCoordinateFromUser(xOrY, grid, plane);
        }
        System.out.println("In bounds");
    ...
    public String getDirectionRoverIsFacingFromUser() {
