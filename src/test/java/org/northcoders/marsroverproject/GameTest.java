...
class GameTest {
    ...
    @Test
    @DisplayName("(1) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatThePlateauReturnedByTheGenerateLiveGamePlateauAsStringBuilderMethodDoesNotContainAnAsteroidIfItsPositionIsNull() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        ...
        // Act 1
        StringBuilder[] result = testGame.generateLiveGamePlateauAsStringBuilder();
    ...
    @Test
    @DisplayName("(2) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatThePlateauReturnedByTheGenerateLiveGamePlateauAsStringBuilderMethodDoesNotContainARoverIfItsPositionIsNull() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        when(mockScanner.nextLine()).thenReturn("3").thenReturn("4");
        testGame.setPlateau(testUser.specifyPlateauSize());
    ...
    @Test
    @DisplayName("(3) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatTheGenerateLiveGamePlateauAsStringBuilderMethodReturnsRedCrossWhenRoverAndAsteroidShareTheSamePositionOnThePlateau() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        when(mockScanner.nextLine()).thenReturn("3").thenReturn("4");
        testGame.setPlateau(testUser.specifyPlateauSize());
        ...
        StringBuilder[] result = testGame.generateLiveGamePlateauAsStringBuilder();
        // Assert 1
        Assertions.assertEquals("❌", String.valueOf(result[2].charAt(1)));
    }

    @Test
    @DisplayName("(4) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatTheGenerateLiveGamePlateauAsStringBuilderMethodReturnsAnAsteroidAndAnUpArrowWhenRoverAndAsteroidOccupyDifferentPositionsOnThePlateauAndRoverIsFacingNorth() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        ...
        StringBuilder[] result = testGame.generateLiveGamePlateauAsStringBuilder();
        // Assert 1
        Assertions.assertEquals("△", String.valueOf(result[0].charAt(3)));
        Assertions.assertEquals("☄", String.valueOf(result[4].charAt(0)));
    }

    @Test
    @DisplayName("(5) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatTheGenerateLiveGamePlateauAsStringBuilderMethodReturnsAnAsteroidAndADownArrowWhenRoverAndAsteroidOccupyDifferentPositionsOnThePlateauAndRoverIsFacingSouth() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        when(mockScanner.nextLine()).thenReturn("5").thenReturn("4");
        testGame.setPlateau(testUser.specifyPlateauSize());
        ...
        StringBuilder[] result = testGame.generateLiveGamePlateauAsStringBuilder();
        // Assert 1
        Assertions.assertEquals("▽", String.valueOf(result[4].charAt(1)));
        Assertions.assertEquals("☄", String.valueOf(result[0].charAt(3)));
    }

    @Test
    @DisplayName("(6) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatTheGenerateLiveGamePlateauAsStringBuilderMethodReturnsAnAsteroidAndALeftArrowWhenRoverAndAsteroidOccupyDifferentPositionsOnThePlateauAndRoverIsFacingWest() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        ...
        StringBuilder[] result = testGame.generateLiveGamePlateauAsStringBuilder();
        // Assert 1
        Assertions.assertEquals("◁", String.valueOf(result[8].charAt(4)));
        Assertions.assertEquals("☄", String.valueOf(result[8].charAt(0)));
    }

    @Test
    @DisplayName("(7) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatTheGenerateLiveGamePlateauAsStringBuilderMethodReturnsAnAsteroidAndARightArrowWhenRoverAndAsteroidOccupyDifferentPositionsOnThePlateauAndRoverIsFacingEast() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        ...
        StringBuilder[] result = testGame.generateLiveGamePlateauAsStringBuilder();
        // Assert 1
        Assertions.assertEquals("▷", String.valueOf(result[3].charAt(6)));
        Assertions.assertEquals("☄", String.valueOf(result[3].charAt(2)));
    }

    @Test
    @DisplayName("(8) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatThePlateauReturnedByTheGenerateLiveGamePlateauAsStringBuilderMethodOnlyContainsXWhenAsteroidSizeIsPlanetDestroyer() {
        // Arrange 1 - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        when(mockScanner.nextLine()).thenReturn("3").thenReturn("4");
        testGame.setPlateau(testUser.specifyPlateauSize());
    ...
    @Test
    @DisplayName("(9) Method being tested = generateLiveGamePlateauAsStringBuilder()")
    void testThatThePlateauReturnedByTheGenerateLiveGamePlateauAsStringBuilderMethodDoesNotOnlyContainXsWhenAsteroidSizeIsNotPlanetDestroyer() {
        // Arrange - @ExtendWith(MockitoExtension.class), @Mock and @InjectMocks
        Game testGame = new Game(testUser);
        when(mockScanner.nextLine()).thenReturn("3").thenReturn("4");
        testGame.setPlateau(testUser.specifyPlateauSize());
        ...
        StringBuilder[] resultForSmallAsteroid = testGame.generateLiveGamePlateauAsStringBuilder();

        boolean doesPlateauOnlyContainCrossesWhenAsteroidIsSmall = false;
        for (StringBuilder sb : resultForSmallAsteroid) {
            if (sb.indexOf("❌") != -1) {
        ...
        StringBuilder[] resultForMediumAsteroid = testGame.generateLiveGamePlateauAsStringBuilder();

        boolean doesPlateauOnlyContainCrossesWhenAsteroidIsMedium = false;
        for (StringBuilder sb : resultForMediumAsteroid) {
            if (sb.indexOf("❌") != -1) {
        ...
        StringBuilder[] resultForLargeAsteroid = testGame.generateLiveGamePlateauAsStringBuilder();
